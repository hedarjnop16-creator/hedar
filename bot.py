...
# ID الأدمن / الإدارة الخاص بك
ADMIN_ID = 123456789  # استبدله بـ ID الخاص بك
...
def process_withdrawal_method(call):
    ...
    msg = bot.send_message(
        ...
        f"يرجى كتابة <b>المعرف أو الرقم الخاص بك</b> لاستلام المبلغ بالإضافة للمبلغ المطلوب سحبه:",
        parse_mode="HTML",
    )
